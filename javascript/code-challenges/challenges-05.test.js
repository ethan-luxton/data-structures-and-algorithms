...
const addPurchases = (arr) => {
  const initialValue = 0;
  return arr.reduce((previousValue, currentValue) => previousValue + currentValue.purchasePrice, initialValue)
};
...
const returnNames = (arr) => {
  return arr.map(x => x.name) // Used map here because I am truly not sure how using arr.reduce is even viable in this situation.
};
